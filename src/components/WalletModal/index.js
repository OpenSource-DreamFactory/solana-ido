...
import OKXcon from "../../assets/images/solana.jpg";
...
export default function WalletModal(props) {
  ...
  function formatConnectorName() {
    ...
    return <WalletName>Connected with Solana(Sol)</WalletName>;
  }
          ...
          <ContentWrapper>
            <YourAccount>
              <InfoCard>
                ...
                <AccountGroupingRow>
                  <AccountControl>
                    <p>{solanaInfo?.publicKey ?? account}</p>
                  </AccountControl>
                </AccountGroupingRow>
              </InfoCard>
            </YourAccount>
